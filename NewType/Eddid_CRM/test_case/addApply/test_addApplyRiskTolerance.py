...
class addApplyRiskTolerance(addApplyTool):
    ...
    @addApplyTool.RiskTolerance(num=2)
    # @unittest.skip("跳过")
    def test_apply_DerivativeProductRiskToleranceLow(self):
        # 用例的前置条件
        # addApplyTool.precondition()
    ...
    @addApplyTool.RiskTolerance(num=1)
    # @unittest.skip("跳过")
    def test_apply_DerivativeProductRiskToleranceMiddle(self):
        # 用例的前置条件
        # addApplyTool.precondition()
    ...
    @addApplyTool.RiskTolerance(num=0)
    # @unittest.skip("跳过")
    def test_apply_DerivativeProductRiskToleranceHigh(self):
        # 用例的前置条件
        # addApplyTool.precondition()
